// this is seed method used to create a seed data for the database which is used as a sample data in the development phase instead of writting the whole thing manually
